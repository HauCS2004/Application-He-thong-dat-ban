...
('M26', N'Chả giò tôm thịt',       N'Dĩa',  'chagiotom.jpg', 'L01', N'Còn món'),
('M27', N'Bánh cuốn Hà Nội',       N'Dĩa',  'banhcuon.jpg', 'L01', N'Còn món'),
('M28', N'Tôm nướng sả ớt',        N'Dĩa',  'tomnuongsa.jpg', 'L01', N'Còn món'),
('M29', N'Bạch tuộc nướng bơ',     N'Dĩa',  'bachtuan.jpg', 'L01', N'Còn món'),
-- Món chính
...
('M30', N'Cá diêu hồng nướng muối', N'Con', 'cadieuhoang.jpg', 'L02', N'Còn món'),
('M31', N'Tôm hùm xốt ớt chua ngọt', N'Kg', 'tomhum.jpg', 'L02', N'Còn món'),
('M32', N'Vịt quay Bắc Kinh',      N'Nửa con', 'vitquay.jpg', 'L02', N'Còn món'),
('M33', N'Lẩu bò nấu riêu',        N'Nồi',  'laubo.jpg',    'L02', N'Còn món'),
('M34', N'Mực nướng sa tế',        N'Dĩa',  'mucnuongsa.jpg', 'L02', N'Còn món'),
-- Cơm mì
...
('M35', N'Cơm chiên tôm',          N'Dĩa',  'comtom.jpg',   'L03', N'Còn món'),
('M36', N'Mì xào bò thơm',         N'Dĩa',  'mixaobo.jpg',  'L03', N'Còn món'),
('M37', N'Bánh ủy',                N'Dĩa',  'banhuy.jpg',   'L03', N'Còn món'),
('M38', N'Phở bò Hà Nội',          N'Tô',   'phobo.jpg',    'L03', N'Còn món'),
-- Đồ uống
...
('M39', N'Bia Sài Gòn',            N'Lon',  'biasaigon.jpg', 'L04', N'Còn món'),
('M40', N'Nước lọc 500ml',         N'Chai', 'nuoclo.jpg',   'L04', N'Còn món'),
('M41', N'Pepsi Cam',              N'Lon',  'pepsicam.jpg', 'L04', N'Còn món'),
('M42', N'Trà lạnh chanh',         N'Ly',   'trachanh.jpg', 'L04', N'Còn món'),
-- Tráng miệng
...
('M43', N'Kem Chocolate tươi',     N'Ly',   'kemchoco.jpg', 'L05', N'Còn món'),
('M44', N'Bánh tiramisu',          N'Cái',  'tiramisu.jpg', 'L05', N'Còn món'),
('M45', N'Chè ba màu',             N'Chén', 'chebamaù.jpg', 'L05', N'Còn món');
GO
...
(1,'M04',85000,N'Giá gốc'),(1,'M05',60000,N'Giá gốc'),(1,'M26',75000,N'Giá gốc'),
(1,'M27',65000,N'Giá gốc'),(1,'M28',120000,N'Giá gốc'),(1,'M29',180000,N'Giá gốc'),
(1,'M06',180000,N'Giá gốc'),(1,'M07',280000,N'Giá gốc'),(1,'M08',320000,N'Giá gốc'),
(1,'M09',220000,N'Giá gốc'),(1,'M10',650000,N'Giá gốc'),(1,'M11',150000,N'Giá gốc'),
(1,'M12',25000,N'Giá gốc'),(1,'M30',250000,N'Giá gốc'),(1,'M31',450000,N'Giá gốc'),
(1,'M32',380000,N'Giá gốc'),(1,'M33',350000,N'Giá gốc'),(1,'M34',165000,N'Giá gốc'),
(1,'M13',120000,N'Giá gốc'),(1,'M14',110000,N'Giá gốc'),(1,'M15',160000,N'Giá gốc'),
(1,'M35',130000,N'Giá gốc'),(1,'M36',125000,N'Giá gốc'),(1,'M37',145000,N'Giá gốc'),
(1,'M38',85000,N'Giá gốc'),(1,'M16',22000,N'Giá gốc'),(1,'M17',25000,N'Giá gốc'),
(1,'M18',18000,N'Giá gốc'),(1,'M19',15000,N'Giá gốc'),(1,'M20',45000,N'Giá gốc'),
(1,'M21',55000,N'Giá gốc'),(1,'M39',20000,N'Giá gốc'),(1,'M40',12000,N'Giá gốc'),
(1,'M41',19000,N'Giá gốc'),(1,'M42',35000,N'Giá gốc'),(1,'M22',70000,N'Giá gốc'),
(1,'M23',120000,N'Giá gốc'),(1,'M24',45000,N'Giá gốc'),(1,'M25',35000,N'Giá gốc'),
(1,'M43',55000,N'Giá gốc'),(1,'M44',95000,N'Giá gốc'),(1,'M45',40000,N'Giá gốc');
...
('0912345678', N'Nguyễn Thị Hương',    N'Kim cương', 2000, 20000000),
('0923456789', N'Trần Anh Tuấn',       N'Vàng',      800,  8000000),
('0934567890', N'Phạm Linh Đan',       N'Bạc',       400,  4000000),
('0945678901', N'Hoàng Minh Khôi',     N'Bạc',       350,  3500000),
('0956789012', N'Vũ Hải Yến',         N'Đồng',      100,  1000000),
('0967890123', N'Lê Văn Cường',        N'Vàng',      1200, 12000000),
('0978901234', N'Chu Thị Thu Hằng',    N'Bạc',       500,  5000000),
('0989012345', N'Dương Quốc Huy',      N'Đồng',      150,  1500000),
('0990123456', N'Đinh Minh Tú',        N'Kim cương', 1800, 18000000),
('0901234567', N'Ưng Thị Hiền',        N'Vàng',      700,  7000000),
('0911111111', N'Cao Văn Dũng',        N'Bạc',       300,  3000000),
('0922222222', N'Bùi Thanh Hương',     N'Đồng',      200,  2000000),
('0933333333', N'Tạ Quang Hải',        N'Vàng',      900,  9000000),
('0944444444', N'Lương Thúc Quý',      N'Kim cương', 1650, 16500000),
('0955555555', N'Đỗ Thị Liên',         N'Bạc',       450,  4500000);
