...
public class HoaDon {
    ...
    private String maNV; // ✅ MỚI: Nhân viên phục vụ
    ...
    public HoaDon(int maHD, Date ngayTao, double tongTien, int trangThai, String maBan,
            int soLuongKhach, String sdtKhach, String ghiChu, String maNV) {
        this.maHD = maHD;
