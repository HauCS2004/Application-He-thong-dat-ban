...
public class ChiTietBangGiaDialog extends JDialog {
    ...
    public ChiTietBangGiaDialog(JPanel parent, int maBG, BangGiaDAO bgDao) {
        super((JFrame) SwingUtilities.getWindowAncestor(parent), true);
        this.bgDao = bgDao;
        this.maDao = new MonAnDAO();
        this.maBG = maBG;

        setTitle("THÊM MÓN TRONG CHIẾN DỊCH");
        setSize(400, 280);
        ...
        pnlHeader.add(UIStyle.title("ÁP GIÁ CHO MÓN ĂN"));
        ...
        for (MonAn m : maDao.getAll()) cboCTMon.addItem(m);
        ...
        JButton btnLuu = UIStyle.button(UIStyle.BtnType.SUCCESS, "THÊM MÓN");
        ...
        cboCTMon.addItemListener(e -> {
            if (e.getStateChange() == java.awt.event.ItemEvent.SELECTED) {
                ...
                if (selectedMon != null && txtDonGia.getText().trim().isEmpty()) {
